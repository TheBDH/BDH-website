...
class Command(BaseCommand):
	...
	def add_arguments(self, parser):
		parser.add_argument('verification', nargs=1, type=str) #string to verify - STalMRQ56AFxEn8fMTb3, only to run ONCE
			...
			# 		maybewrong = models.IntegerField()'''
					...
					for res in myresult:
						...
						if res[1] == "" or res[2] == "":
							namearr = res[5].split(" ")
						print(res)
						author = Author(id = res[0], first_name = res[1],last_name = res[2],about = res[3],pathtopicture = res[4],email = res[6],since = res[7], valid=True,maybewrong = boole)
						author.save()
